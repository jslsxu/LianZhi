...
- (void)viewDidLoad {
    ...
    [_registerButton setBackgroundImage:[UIImage imageWithColor:kCommonParentTintColor size:_registerButton.size cornerRadius:5] forState:UIControlStateNormal];
