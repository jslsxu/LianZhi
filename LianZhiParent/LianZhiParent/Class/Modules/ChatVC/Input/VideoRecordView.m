...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        [_progressView setBackgroundColor:kCommonParentTintColor];
        [_contentView addSubview:_progressView];
        
        _captureButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [_captureButton.layer setBorderColor:kCommonParentTintColor.CGColor];
        ...
        [_captureButton setTitleColor:kCommonParentTintColor forState:UIControlStateNormal];
