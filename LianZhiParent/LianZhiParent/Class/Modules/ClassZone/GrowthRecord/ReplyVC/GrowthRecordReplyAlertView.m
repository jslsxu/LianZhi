//
//  GrowthRecordReplyAlertView.m
//  LianZhiParent
//
//  Created by jslsxu on 17/2/24.
//  Copyright © 2017年 jslsxu. All rights reserved.
//

#import "GrowthRecordReplyAlertView.h"
#import "LZKVStorage.h"
@interface GrowthRecordReplyAlertView ()
@property (nonatomic, strong)UIButton*  bgButton;
@property (nonatomic, strong)UIView*    contentView;
@property (nonatomic, copy)void (^completion)();
@end

@implementation GrowthRecordReplyAlertView

+ (void)showAlertViewWithCompletion:(void (^)())completion{
    BOOL hiddenAlert = [[NSUserDefaults standardUserDefaults] boolForKey:@"GrowthRecordReplyAlert"];
    if(!hiddenAlert){
        GrowthRecordReplyAlertView *alertView = [[GrowthRecordReplyAlertView alloc] init];
...
- (void)setupContentView:(UIView *)viewParent{
    ...
    [contentLabel setText:@"回复后就不能再修改了"];
...
- (void)showAlertToggle:(UIButton *)button{
    ...
    [[NSUserDefaults standardUserDefaults] setBool:button.selected forKey:@"GrowthRecordReplyAlert"];
