...
- (instancetype)initWithTitle:(NSString *)title buttonItems:(NSArray *)items
{
    ...
    if(self)
    {
        ...
        for (NSInteger i = 0; i < items.count; i++) {
            ...
            [button setBackgroundImage:[[UIImage imageNamed:MJRefreshSrcName(@"GreenBG.png")] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateNormal];
