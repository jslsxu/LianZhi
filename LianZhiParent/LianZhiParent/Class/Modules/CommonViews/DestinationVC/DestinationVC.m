...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation
{
    if ([annotation isKindOfClass:[BasicMapAnnotation class]])
    {
        ...
        if (!annotationView)
        {
            ...
            [button setBackgroundImage:[[UIImage imageWithColor:kCommonParentTintColor size:CGSizeMake(10, 10) cornerRadius:2] resizableImageWithCapInsets:UIEdgeInsetsMake(2, 2, 2, 2)] forState:UIControlStateNormal];
