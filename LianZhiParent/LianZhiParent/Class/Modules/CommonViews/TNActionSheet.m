    ...
    if(self)
    {
        ...
        for (TNButtonItem *item in items) {
            ...
            else
            {
                ...
                [button setBackgroundImage:[[UIImage imageNamed:MJRefreshSrcName(@"GreenBG")] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateNormal];
            }
