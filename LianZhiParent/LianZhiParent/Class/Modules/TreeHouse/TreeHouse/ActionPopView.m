...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        NSArray *titleArray = @[@"发文字",@"发照片",@"发语音"];
        NSArray *imageArray = @[@"TreeHouseAddText",@"TreeHouseAddPhoto",@"TreeHouseAddAudio"];
         NSInteger itemHeight = _contentView.height / titleArray.count;
        for (NSInteger i = 0; i < titleArray.count; i++)
        {
            ...
            {
                UIView *sepLine = [[UIView alloc] initWithFrame:CGRectMake(0, button.bottom, _contentView.width, 0.5)];
