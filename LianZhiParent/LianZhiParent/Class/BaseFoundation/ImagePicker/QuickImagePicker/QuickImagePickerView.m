...
- (UIView *)toolBar{
    if(_toolBar == nil){
        ...
        [_albumButton setTitleColor:kCommonParentTintColor forState:UIControlStateNormal];
...
//        [_toolBar addSubview:_originalImageButton];
        ...
        [_sendButton setBackgroundImage:[UIImage imageWithColor:kCommonParentTintColor size:_sendButton.size cornerRadius:3] forState:UIControlStateNormal];
