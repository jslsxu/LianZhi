...
//    
//    CGSize strSize = [string boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, 0) andFont:self.moreOptionsButton.titleLabel.font];
//    CGFloat width = roundf(strSize.width) + 2 * self.menuOptionButtonTitlePadding;
