...
- (instancetype)init
{
    ...
    if(self)
    {
        ...
        [_confirmButton setBackgroundImage:[UIImage imageWithColor:kCommonParentTintColor size:_confirmButton.size cornerRadius:10] forState:UIControlStateNormal];
