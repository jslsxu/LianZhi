...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(maxWidth, 0) andFont:label.font];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize andFont:detailsLabel.font];
