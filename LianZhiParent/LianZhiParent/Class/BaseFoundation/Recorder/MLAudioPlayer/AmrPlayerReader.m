...
int amrEncodeModeOld[] = {4750, 5150, 5900, 6700, 7400, 7950, 10200, 12200}; // amr 编码方式
...
- (BOOL)openFileWithPlayer:(MLAudioPlayer*)player
{
    ...
    size_t realReadedLength = fread(magic, sizeof(char), strlen(amrHeader), _file);
