...
- (instancetype)initWithTitle:(NSString *)title buttonItems:(NSArray *)items
{
    ...
    if(self)
    {
        ...
        [_bgView setBackgroundColor:kCommonTeacherTintColor];
        ...
        for (NSInteger i = 0; i < items.count; i++)
        {
            ...
            [button setBackgroundImage:[UIImage imageWithColor:kCommonTeacherTintColor size:CGSizeMake(10, 10)] forState:UIControlStateHighlighted];
            [button addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
            [button setTitleColor:kCommonTeacherTintColor forState:UIControlStateNormal];
