...
- (void)setupSubviews
{
    ...
    [_originalPasswordField setTextColor:kCommonTeacherTintColor];
    ...
    [_newPasswordField setTextColor:kCommonTeacherTintColor];
    ...
    [_confirmPasswordField setTextColor:kCommonTeacherTintColor];
