...
- (instancetype)initWithPoint:(CGPoint)point action:(Action)action
{
    ...
    if(self)
    {
        ...
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(point.x - kActionViewWidth - 10, point.y - 18, kActionViewWidth, kActionViewHeight)];
