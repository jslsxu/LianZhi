...
- (void)viewDidLoad {
    ...
    [_registerButton setBackgroundImage:[UIImage imageWithColor:kCommonTeacherTintColor size:_registerButton.size cornerRadius:5] forState:UIControlStateNormal];
